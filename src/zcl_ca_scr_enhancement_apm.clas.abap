...
CLASS zcl_ca_scr_enhancement_apm DEFINITION PUBLIC
                                 FINAL
                                 CREATE PUBLIC.
...
CLASS ZCL_CA_SCR_ENHANCEMENT_APM IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    zif_apack_manifest~descriptor =
         VALUE #(
            group_id        = 'itinere.at'
            artifact_id     = 'zca_tbx_screen_enhancement'
            version         = '1.0.0'
            repository_type = 'abapGit'
            git_url         = 'https://github.com/JSB-Vienna/zca_tbx_screen_enhancement.git'
            dependencies    =
                  VALUE #(
                      ( group_id       = 'itinere.at'
